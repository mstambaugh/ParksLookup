        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<NativeSpecies>()
                .HasData(
                    ...
                    new NativeSpecies { NativeSpeciesId = 5, ParkId = 1, Kingdom = "Plantae", Class = "Pinaceae", Species = "Pinus Albicaulis", CommonName = "White-barked Pine", SpeciesDescription = "The whitebark pine is typically the highest-elevation pine tree found in Western US mountain ranges and often marks the tree line. Thus, it is often found as krummholz, trees growing close to the ground that have been dwarfed by exposure. In more favorable conditions, the trees may grow to 29 meters (95 ft) in height.", ConservationStatus = "endangered" }
                );
        }
    }
}